...
namespace OZZ::collision::shapes {
    ...
    enum class OzzShapeKind { Unknown = -1, Point, Rectangle, Circle, Line, Polygon };

    using OzzShapeData = std::variant<OzzPoint, OzzRectangle, OzzCircle, OzzLine, OzzPolygon>;
