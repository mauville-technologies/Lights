...
namespace OZZ::game::objects {
    ...
    public:
        struct TextInputParams {
            ...
            TextInputParams()
                : FontSize(32), FontPath(""), Size(200.f, 50.f), BackgroundColor(0.2f, 0.2f, 0.2f, 1.f),
                  CursorColor(1.f, 1.f, 1.f), TextColor(1.f, 1.f, 0.f), FocusedColor(1.f, 0.f, 0.5f, 1.f),
                  FocusedThickness(5.f), TextAnchorPoint(AnchorPoint::LeftMiddle), bIsPassword(false) {}
        };

        using ParamsType = TextInputParams;
        explicit TextInput(uint64_t inId,
